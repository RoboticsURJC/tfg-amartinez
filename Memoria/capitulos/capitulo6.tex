...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figs/collage_impulsores.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figs/modificaciones.jpg}
...
La Figura~\ref{fig:sync} muestra una captura correspondiente a ambas pruebas realizadas. El desarrollo de esta funcionalidad puede consultarse en la Wiki del proyecto\footnote{\url{https://tinyurl.com/mryfxb8a}, \url{https://tinyurl.com/mr29pyxv}}. El proceso de sincronización de medicamentos puede consultarse en el vídeo asociado\footnote{\url{https://tinyurl.com/uuppxkhh}}. Asimismo la sincronización bidireccional de tomas puede consultarse en el vídeo asociado\footnote{\url{https://tinyurl.com/yeyz9pc4}}.

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{figs/sincronizacion.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figs/posiciones_pulso.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{figs/historial_csv.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{figs/pdf_historial.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{figs/validacion_pin.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figs/sincronizacion_pin.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{figs/token_vinculacion.jpg}
