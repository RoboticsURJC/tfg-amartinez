...
%\begin{figure}[H]
 % \centering
  %\begin{minipage}[t]{0.45\textwidth}
   % \centering
    %\includegraphics[height=4.5cm,width=7.25cm]{figs/primer_robot_industrial.png}
  ...
  %\begin{minipage}[t]{0.45\textwidth}
   % \centering
    %\includegraphics[height=4.5cm,width=7.25cm]{figs/brazo_kuka.png}
...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[height=5cm,width=7.5cm]{figs/amazon_warehouse.png}
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[height=5cm,width=7.5cm]{figs/Cobot.png}
...
\includegraphics[height=5.4cm, width=0.35\textwidth]{figs/bestic.png}
...
\begin{figure} [H]
  \begin{center}
    \includegraphics[width=0.85\textwidth]{figs/CMR-Versius.png}
  \end{center}
...
\includegraphics[height=6.6cm, width=0.45\textwidth]{figs/aethon.png}
\hspace{0.02\textwidth}
...
\begin{figure} [H]
  \begin{center}
    \includegraphics[width=0.95\textwidth]{figs/diagrama_hogar.png}
  \end{center}
...
\begin{figure} [H]
  \begin{center}
    \includegraphics[width=0.9\textwidth]{figs/bajo_coste_diagrama.png}
  \end{center}
