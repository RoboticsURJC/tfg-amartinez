...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.45\textwidth}
    ...
    \small a) General Motors introduce Unimate\footnotemark\ robots de soldadura por puntos.
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.45\textwidth}
    \centering
...
\begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[height=4.5cm,width=7.5cm]{figs/primer_robot_industrial.jpg}
...
\begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[height=4.5cm,width=7.5cm]{figs/brazo_kuka.jpg}
...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[height=5cm,width=7.5cm]{figs/Cobot.jpg}
...
En este entorno, los enfoques de aprendizaje automático, especialmente el aprendizaje profundo (\textit{deep learning}), han desempeñado un papel esencial en la evolución de la robótica moderna. Estas perspectivas posibilitan que los sistemas se instruyan con datos, optimicen su comportamiento conforme ganan experiencia y enfrenten problemas complejos que son difíciles de modelar explícitamente. En la Figura~\ref{fig:ejemplos_tr} se muestra un robot que es capaz de planificar trayectorias independientemente de la dificultad de la superficie.

\begin{figure} [H]
  \begin{center}
    \includegraphics[height=4.5cm,width=9cm]{figs/planificacion_trayectorias.jpg}
  \end{center}
  \caption{Ejemplo de planificación de trayectorias.}
  \label{fig:ejemplos_tr}
\end{figure}

Históricamente, la visión artificial ha sido uno de los sensores más importantes en los sistemas robóticos, sobre todo en aplicaciones de manipulación, inspección y guiado. Sin embargo, durante décadas su rendimiento estuvo restringido debido a las limitaciones en el procesamiento, lo que ocasionaba un \textit{embotellamiento} computacional al lidiar con la alta cantidad de datos generados por sensores ópticos y cámaras. En la Figura~\ref{fig:ejemplos_dl} se muestra un ejemplo de cómo los robots son capaces de detectar patrones y clasificar objetos.

\begin{figure} [H]
  \begin{center}
    \includegraphics[height=6.9cm,width=\textwidth]{figs/deep_learning.jpg}
  \end{center}
  \caption{Ejemplo de clasificación de objetos.}
  \label{fig:ejemplos_dl}
\end{figure}

En los últimos años, la fusión de métodos avanzados de inteligencia artificial, especialmente aquellos que se apoyan en el aprendizaje profundo, ha permitido superar estas limitaciones gracias al aumento notorio de la capacidad de cálculo. En consecuencia, los sistemas robóticos actuales son capaces de procesar información visual en tiempo real con más exactitud, rapidez y robustez. Esto ha mejorado significativamente su autonomía y su habilidad para adaptarse a entornos no controlados. Una estructura básica de los sistemas basados en visión se puede ver en la Figura~\ref{fig:ia_diagram}.

\begin{figure} [H]
  \begin{center}
    \includegraphics[width=\textwidth]{figs/ia_diagram.jpg}
  \end{center}
...
En la Figura~\ref{fig:ejemplos_hr} vemos casos donde hay interacción humano-robot en entornos públicos, como pueden ser el supermercado o la vía pública.\\

\begin{figure} [H]
  \begin{center}
    \includegraphics[height=5cm,width=7.5cm]{figs/robot_supermercado.jpg}
...
La robótica de servicio se divide generalmente en dos grandes categorías: robots de servicio profesionales y robots de servicio personales. Los robots profesionales están destinados a entornos laborales específicos y son operados por personal cualificado, como ocurre en el caso de los robots médicos quirúrgicos, los robots logísticos utilizados en almacenes, los sistemas de inspección industrial o los robots de seguridad y vigilancia. En la Figura~\ref{fig:ejemplos_rspro} se muestran dos ejemplos de robots de servicio profesionales.

\begin{figure}[H]
  \centering
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[height=4.75cm,width=7.5cm]{figs/Da-Vinci_01-1.jpg}
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[height=4.75cm,width=7.5cm]{figs/logistico.jpg}
...
Por otro lado, los robots de servicio personales están diseñados para ser utilizados directamente por usuarios no especializados en entornos cotidianos. Dentro de esta categoría se incluyen los robots domésticos de limpieza, los robots asistenciales orientados al apoyo de personas mayores o con discapacidad, los robots educativos y de entretenimiento, así como los asistentes virtuales integrados en dispositivos inteligentes del hogar. En la Figura~\ref{fig:ejemplos_rsp} se pueden ver diferentes tipos de robots de servicio personales.

\begin{figure}[H]
\centering

\includegraphics[height=5.4cm, width=0.35\textwidth]{figs/bestic.jpg}
\hspace{0.11\textwidth}
\includegraphics[height=5.4cm, width=0.35\textwidth]{figs/ecovast.jpg}
...
\begin{figure} [H]
  \begin{center}
    \includegraphics[width=0.75\textwidth]{figs/rosa.jpg}
  \end{center}
...
\begin{figure} [H]
  \begin{center}
    \includegraphics[width=0.85\textwidth]{figs/CMR-Versius.jpg}
  \end{center}
...
\includegraphics[height=6.6cm, width=0.45\textwidth]{figs/aethon.jpg}
\hspace{0.02\textwidth}
\includegraphics[height=6.6cm, width=0.45\textwidth]{figs/robot_rehab.jpg}
...
\begin{figure} [H]
  \begin{center}
    \includegraphics[width=0.95\textwidth]{figs/diagrama_hogar.jpg}
  \end{center}
...
La administración adecuada de la medicación es una de las tareas más cruciales en la atención sanitaria, particularmente en el hogar. La administración de medicamentos requiere que las dosis y los horarios de las tomas estén bajo una supervisión rigurosa, porque cualquier error podría poner en riesgo la salud del paciente o afectar la eficacia del tratamiento. En este contexto, la automatización y la robótica brindan una excelente oportunidad para crear soluciones que simplifiquen y supervisen este proceso, ayudando a disminuir los olvidos, los errores de las personas y las circunstancias peligrosas. En la Figura~\ref{fig:dispensador_sad} se puede ver un ejemplo de SAD (Sistema Automatizado de Dispensación) empleado en hospitales o centros sociosanitarios para la gestión interna de fármacos.\\

\begin{figure} [H]
  \begin{center}
    \includegraphics[width=0.5\textwidth]{figs/sad.jpg}
  \end{center}
  \caption{SAD - Sistema Automatizado de Dispensación.}
  \label{fig:dispensador_sad}
\end{figure}

Asimismo, en la Figura~\ref{fig:dispensador_spd} se muestra un SPD (Sistema Personalizado de Dosificación) empleado en farmacia comunitaria para pacientes crónicos en sus casas (generalmente semanal).\\

\begin{figure} [H]
  \begin{center}
    \includegraphics[width=0.55\textwidth]{figs/spd.jpg}
  \end{center}
  \caption{SPD - Sistema Personalizado de Dosificación.}
  \label{fig:dispensador_spd}
\end{figure}

No obstante, el desarrollo de sistemas robóticos enfocados en la asistencia sanitaria supone varios desafíos, entre los que sobresalen la confiabilidad, la seguridad y la accesibilidad de las soluciones sugeridas. Para que estos sistemas se adopten en contextos reales, es esencial que sean de fácil uso, para usuarios que carecen de conocimientos técnicos, y que tengan un coste asequible. Estos aspectos adquieren particular importancia cuando se refiere a dispositivos diseñados para el uso en casa, en los que la sencillez de uso y el precio se vuelven elementos cruciales. La robótica de bajo coste es la rama de la robótica que satisface estos dos requerimientos.\\
...
La robótica de bajo coste se enfoca en crear sistemas robóticos que utilizan tecnologías y componentes económicos, sin sacrificar la funcionalidad básica del sistema. El propósito principal de este método es incrementar el acceso a la robótica, haciendo más fácil su implementación, por ejemplo, en entornos educativos (Figura~\ref{fig:robot_lowcost}-a), en visión computacional (Figura~\ref{fig:robot_lowcost}-b), en domótica del hogar (Figura~\ref{fig:robot_lowcost}-c), en entornos sanitarios y en aplicaciones reales enfocadas al usuario final. La disminución de costes posibilita que estas soluciones sean replicadas, adaptadas y aplicadas con más sencillez en una extensa variedad de aplicaciones.
...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[height=5.95cm,width=7.75cm]{figs/raspberry.jpg}
...
\subfigure[Sensor infrarrojos (IR).]{
    \includegraphics[height=5.5cm, width=0.27\textwidth]{figs/s_ifr.jpg}
}
...
\begin{figure} [H]
  \begin{center}
    \includegraphics[width=0.9\textwidth]{figs/bajo_coste_diagrama.jpg}
  \end{center}
