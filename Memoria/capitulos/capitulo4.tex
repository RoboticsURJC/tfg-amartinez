...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.45\textwidth}
    \centering
    \includegraphics[height=7.15cm,width=5.75cm]{figs/bambulab.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{figs/Trinquete_mecanismo.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figs/altavoz.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figs/platformio.jpg}
