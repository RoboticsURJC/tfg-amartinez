...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figs/collage_PIN.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{figs/paso1_conf.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{figs/paso2_conf.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{figs/paso3_conf.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figs/collage_paso4_conf.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figs/collage_paso5_conf.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figs/collage_paso7_conf.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figs/collage_pantallas_principales.jpg}
...
Cada uno de los 13 compartimentos destinados a la medicación corresponde a una toma concreta. El compartimento situado inicialmente frente a la abertura de dispensación debe permanecer vacío para permitir el correcto funcionamiento del mecanismo.
...
\textbf{Importante:} Antes de configurar las tomas, rellene únicamente los \textbf{13 compartimentos destinados a la medicación}. El compartimento que inicialmente coincide con la abertura de dispensación debe permanecer vacío, ya que corresponde a la posición de salida de las pastillas. De este modo, cada avance del mecanismo situará correctamente la siguiente toma en la posición de dispensación.\\

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figs/medicamentos_manual.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figs/añadir_toma_manual.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figs/editar_toma_manual.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figs/eliminar_toma_manual.jpg}
