...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figs/collage_app.png}
...
Con el objetivo de complementar las funcionalidades del dispensador, se ha incorporado un sistema de monitorización biomédica basado en el sensor MAX30102.\\
