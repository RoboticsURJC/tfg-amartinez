...
En cuanto a su capacidad de procesamiento, el ESP32 cuenta con un procesador de doble núcleo que permite gestionar múltiples tareas de forma eficiente, como la lectura de sensores o la actualización de la interfaz gráfica.
...
\begin{figure}[H]
  ...
  \caption{Impresoras empleadas para imprimir el sieño mecánico del sistema.}
...
Para transformar el movimiento del servomotor en un desplazamiento discreto y preciso de los compartimentos, se ha planteado el uso de un mecanismo de \textit{Rueda de Ginebra} {\url{https://es.wikipedia.org/wiki/Rueda_de_Ginebra}}. Este tipo de mecanismo permite convertir un movimiento continuo o controlado en un movimiento intermitente por pasos, lo que resulta especialmente adecuado en aplicaciones de indexado como la presente.\\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{figs/ginebra.png}
    \caption{Representación de ejemplo de un mecanismo de \textit{Rueda de Ginebra}.}
    \label{fig:ginebra}
\end{figure}
...
El uso de esta herramienta ha permitido adaptar el diseño del dispositivo a los requisitos del proyecto, facilitando de esta froma la iteración y mejora de las piezas hasta obtener una solución funcional.
