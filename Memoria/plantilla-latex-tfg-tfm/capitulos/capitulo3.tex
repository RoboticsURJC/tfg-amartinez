...
\item El coste total del prototipo deberá mantenerse dentro de un rango reducido, no superando los \euro {50} aproximadamente, con el fin de garantizar su accesibilidad.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figs/PDCA_esquema.png}
