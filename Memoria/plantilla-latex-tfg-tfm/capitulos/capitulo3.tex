...
Con esta finalidad, el objetivo principal del presente trabajo es la creación y elaboración de un sistema robótico de bajo coste, orientado a la asistencia sanitaria en el hogar, basado en sensores, un microcontrolador con pantalla táctil y una aplicación móvil de supervisión. El sistema se compone de un pastillero automatizado que puede manejar la gestión de medicamentos a través de alertas acústicas y visuales, además de registrar parámetros fisiológicos como la saturación de oxígeno en sangre y el ritmo cardíaco.\\
...
\item El coste total del prototipo deberá mantenerse dentro de un rango reducido, no superando aproximadamente los 50 €, con el fin de garantizar su accesibilidad.
...
El proceso de desarrollo se ha apoyado en un enfoque iterativo basado en el ciclo Plan–Do–Check–Act (PDCA), que ha permitido la mejora continua del sistema mediante la implementación, verificación y optimización de sus funcionalidades. Este enfoque se ha complementado con reuniones periódicas con el tutor, en las que se han revisado los avances, resuelto dudas y planificado las siguientes etapas del proyecto, facilitando un desarrollo estructurado y progresivo.
