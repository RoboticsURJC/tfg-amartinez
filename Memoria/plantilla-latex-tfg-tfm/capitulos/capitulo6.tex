...
La Figura~\ref{fig:estabilizacion_medida} muestra una captura correspondiente a uno de los ensayos realizados. El vídeo completo de la prueba puede consultarse en el Anexo~\ref{anexo:videos}.
...
La Figura~\ref{fig:posiciones_pulso} muestra las diferentes configuraciones evaluadas durante las pruebas. Para que los resultados sean más fáciles de reproducir, se grabaron las dos rondas completas de ensayos. Los vídeos correspondientes pueden consultarse en el Anexo~\ref{anexo:videos}.
