...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{imagenes/funcionamiento_autonomo.jpeg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{figs/persistencia_tomas.jpeg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{figs/historial_csv.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.55\textwidth]{figs/historial_esp.jpeg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth]{figs/historial_android.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{figs/pdf_historial.png}
...
Se implementó un mecanismo de autenticación basado en un PIN configurable por el usuario. Para validar su funcionamiento se realizaron diferentes pruebas introduciendo tanto códigos correctos como incorrectos desde la aplicación móvil y desde el dispositivo.\\
...
Los resultados obtenidos confirman el correcto funcionamiento del mecanismo de autenticación implementado.
