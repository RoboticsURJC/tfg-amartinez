...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{figs/mecanismo.png}
...
Este sensor integra emisores LED y un fotodiodo capaces de realizar mediciones ópticas mediante fotopletismografía (PPG), técnica ampliamente utilizada para estimar parámetros fisiológicos como la frecuencia cardíaca.\\

La Figura~\ref{fig:max30102_flow} resume las diferentes etapas empleadas para obtener la frecuencia cardíaca a partir de la señal capturada por el sensor.\\
