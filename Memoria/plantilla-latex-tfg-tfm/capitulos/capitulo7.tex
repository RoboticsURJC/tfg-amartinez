...
Además de los objetivos planteados inicialmente, también se han satisfecho los requisitos técnicos establecidos para el desarrollo del sistema:
...
Además de las competencias definidas inicialmente en la Sección 3.3, el desarrollo de este Trabajo Fin de Grado ha permitido adquirir y reforzar conocimientos en diferentes áreas de la ingeniería, entre los que destacan:
...
En conjunto, estas líneas futuras permitirían evolucionar MyMeds desde un prototipo funcional de asistencia sanitaria doméstico hacia un producto más completo, escalable y adaptado a entornos reales de uso.
